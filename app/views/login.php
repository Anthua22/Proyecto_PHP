        ...
        <div class="row">
            <div class="col-md-12">
                <div class="header-left">
                    <div class="logo">
                        <a href="index.view.php"><img src="../../images/logo.png" alt=""/></a>
                    </div>
                    <div class="menu">
                        ...
                        <ul class="nav" id="nav">
                            ...
                            <li><a href="show-equipo.view.php">Contact</a></li>
                            <div class="clear"></div>
                        </ul>
            ...
            <dl id="sample" class="dropdown">
                ...
                <dd>
                    <ul>
                        ...
                        <li><a href="#">Sri Lanka<img class="flag" src="../../images/srl.png" alt=""/><span class="value">SL</span></a>
                        </li>
